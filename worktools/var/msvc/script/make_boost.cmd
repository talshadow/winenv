...
if /i "%CXX%" EQU "gcc" set boost_settings=%boost_settings% toolset=gcc
...
if /i "%CXX%" EQU "gcc" set boost_settings=%boost_settings% -sICU_LINK="-L$ICU_PATH/lib -licuuc -licuin -licudt"
...
if /i "%CXX%" EQU "gcc" set boost_bjam_settings=gcc
