...
call set LocVar=!%LocVar%!
%1 %locVar% || cd .. && exit /b 2
call %MAKE_TOOL% || cd .. && exit /b 2
call %MAKE_TOOL% install || cd .. && exit /b 2
exit /b
rem ***************************************************************************************
:MOVE_LIB_DLL_TO_BIN
set tmppath=%~1
